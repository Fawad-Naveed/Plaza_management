-- Create pending_payments table for payment approval workflow (FIXED VERSION)
...
CREATE INDEX IF NOT EXISTS idx_pending_payments_submitted_at ON pending_payments(submitted_at);
...
DROP TRIGGER IF EXISTS trigger_update_pending_payments_updated_at ON pending_payments;
